...
analyze = function (range, mode) {
    ...
    names(r) = c("% Exp", "Dex Expressed",
             "Num Expressed", "Num Total",
             "Exp.TD 0.01", "Exp.TD at 0.05", "Exp.TD at 0.20",
             "All.TD 0.01","All.TD 0.05", "All.TD 0.20",
             "Exp.FD 0.01", "Exp.FD at 0.05", "Exp.FD at 0.20",
             "All.FD 0.01","All.FD 0.05", "All.FD 0.20",
...
if (!is.na(arg1) || arg1 < 1) {
    ...
    # Output results
    write.table(r, file=paste0("summaries/", subdir, "1-5k_", prog, "_", modes[arg1], ".txt"), sep="\t", quote=FALSE)
}
